...
video2world_7b_driving = LazyDict(
    dict(
        ...
        checkpoint=dict(
            ...
            # save_iter=1,
            broadcast_via_filesystem=False,
            load_path="/capstor/scratch/cscs/yhaghigh/cosmos_predict_dev/checkpoints/nvidia/Cosmos-Transfer1-7B-Sample-AV/base_model.pt", #"/capstor/scratch/cscs/yhaghigh/cosmos_predict_dev/checkpoints/Cosmos-Predict1-7B-Video2World/model.pt",
            load_training_state=False,
            strict_resume=False,
            keys_not_to_resume=[],
        ),
